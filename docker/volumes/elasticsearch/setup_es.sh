...
# If ES_ADDR argument is provided, use it. Otherwise, use environment variable or default logic.
...
# If INDEX_DIR argument is provided, use it. Otherwise, use the default.
